...
```{r setup, echo = FALSE}
knitr::opts_chunk$set(fig.width = 8, fig.height = 4.5, dpi = 300, dev.args = list(type = "cairo"), dev = 'png')
```
...
```{r plot-precision-matrices, warning = FALSE, cache = TRUE, dependson = "simulate_data", fig.align = 'center', dev.args = list(pointsize = 4)}
...
```{r plot-sampled-data, cache = TRUE, dependson = "simulate_data", fig.align = 'center', fig.height = 4.5, fig.width = 4.5}
data.frame(
  x     = locs_s[, 1],
  y     = locs_s[, 2],
...
```{r trace-plots, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center'}
...
```{r trace-plots-alpha, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center'}
...
```{r estimated-vs-predicted, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center'}
...
```{r estimated-alphas, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center', warning = FALSE}
...
```{r simulated-vs-estimated-process, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center'}
...
```{r plot-sim-vs-fitted-effects, cache = TRUE, dependson = c("simulate_data", "fit-model"), fig.align = 'center'}
